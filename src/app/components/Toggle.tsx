...
export default function Toggle({value, setValue}: {value: boolean, setValue: () => void}) {
  return (
    <label className="inline-flex z-50 fixed items-center  left-5 bottom-5">
      <input className="peer hidden" id="toggle" checked={value} onChange={setValue} type="checkbox" />
      <div className="relative w-[110px] h-[50px] bg-gray-100 peer-checked:bg-zinc-500 rounded-full after:absolute after:content-[''] after:w-[40px] after:h-[40px] after:bg-gradient-to-r from-violet-500 to-purple-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[5px] after:left-[5px] active:after:w-[50px] peer-checked:after:left-[105px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"></div>
      <svg
        height="0"
        width="100"
        viewBox="0 0 24 24"
